...
$config['page_slug'] 	= 'vw-gardening-landscaping-pro';
...
$config['steps'] = array( 
	'intro' => array(
		...
		'title'			=> __( 'Welcome to ', 'vw-gardening-landscaping-pro' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', // Uses Dashicons
		'button_text'	=> __( 'Start Now', 'vw-gardening-landscaping-pro' ), // Button text
	...
	'widgets' => array(
		'id'			=> 'widgets',
		'title'			=> __( 'Demo Importer', 'vw-gardening-landscaping-pro' ),
