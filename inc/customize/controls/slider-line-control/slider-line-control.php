<?php
	...
	class vw_gardening_landscaping_pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function vw_gardening_landscaping_pro_Slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'vw_gardening_landscaping_pro_Slider_line_script' );
