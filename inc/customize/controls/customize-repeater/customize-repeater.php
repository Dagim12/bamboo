 ...
 */
class vw_gardening_landscaping_pro_Repeater_Custom_Control extends WP_Customize_Control {
	/**
	...
	public function __construct( $manager, $id, $args = array(), $options = array() ) {
		...
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'add' => __( 'Add', 'vw-gardening-landscaping-pro' ),
			)
		);
	}
	/**
	...
	public function render_content() {
		...
		$section_name = array("our-expertise","about-us","our-services","working-process","our-projects","pricing-plan","product-records","testimonials","team","why-choose-us","blog-partners","gallery","content-area");
