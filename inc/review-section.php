 ...
 * @access public
 */
class vw_gardening_landscaping_pro_customize_reviews_and_testimonials extends WP_Customize_Section {
     ...
     * @var    string
     */
    public $type = 'vw-gardening-landscaping-pro';
    ...
    protected function render_template() { ?>
        ...
        <li id="accordion-section-{{ data.id }}" class="accordion-section control-section control-section-{{ data.type }} cannot-expand theme-custom-section">
