...
get_header();
if(get_theme_mod('vw_gardening_landscaping_pro_products_shop_page_sidebar',true)=='1'){
...
<div class="container shop-page">
	...
	<div class="row">
		...
		<?php if(get_theme_mod('vw_gardening_landscaping_pro_products_shop_page_sidebar',true)=='1'){ ?>
